      ...
      <div className="l-page">
        <div className="l-1">
          <nav className="navbar">
            <div className="logo">
              <Link to="/" style={{color: "white"}}>Career</Link><Link to="/">Connect</Link>
            </div>
            <ul>
              <li>
          ...
          <div className="foralign">
            <div className="main-text">CareerConnect</div>
        ...
        <div className="l-4">
          ...
          <div className="big-num" style={{textAlign:"center"}}>289</div>
          ...
          <div className="l-button">
            <div className="l-3-btn last-btn-2">
              <Link to="/signupoption" ><p style={{textDecorationColor:"black"}}>Get Started</p></Link>
              <FontAwesomeIcon icon={faChevronRight} />
            </div>
          </div>
        </div>
